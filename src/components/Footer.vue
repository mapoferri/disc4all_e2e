...
<script>
  import { ref } from 'vue';
  import { MDBModal, MDBModalHeader, MDBModalTitle, MDBModalBody, MDBTextarea, MDBInput,  MDBModalFooter, MDBFooter, MDBContainer, MDBRow, MDBCol, MDBBtn, MDBIcon } from 'mdb-vue-ui-kit';
